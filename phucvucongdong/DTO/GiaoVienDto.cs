...
namespace phucvucongdong.Entities.DTO
{
    ...
    public class GiaoVienXacNhanMinhChungCuaSinhVien
    {
    ...
    public class QuanSinh_LayDanhSachGiaoVien
    {
        public int giao_vien_id { get; set; }
        public string? ma_so_giao_vien { get; set; }
        public string? ho_ten_giao_vien { get; set; }
    ...
    public class QuanSinh_LayDanhSachLopCuaSinhVien
    {
        // public int nguoi_dung_id { get; set; }
        public string? lop { get; set; }
    ...
    public class DanhSachSinhVienTheoLop
    {
        public int sinh_vien_id { get; set; }
        public string? ma_so_sinh_vien { get; set; }
        public string? ho_ten_sinh_vien { get; set; }
    ...
    public class HoatDongChiTietMaGiaoVienThamGia
    {
        public string? ho_ten_giao_vien { get; set; }
        public string? ma_so_giao_vien { get; set; }
        public string? lop_phu_trach { get; set; }
    ...
    public class HoatDongCaNhanCuaGiaoVien
    {
        public string? ten_hoat_dong { get; set; }
